...
const packages = [
  {
    id: 1,
    image: "https://images.unsplash.com/photo-1573398643956-2b9e6ade3456?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Sikkim Highlights | Skyline And Sandscapes",
  ...
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1600402808924-9c591a6dace8?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Escape To Sikkim | Flights Inclusive Deal",
    duration: "5 days & 4 nights",
    rating: "5.0",
    reviews: "1.2k",
    oldPrice: "1,24,761",
  ...
  {
    id: 3,
    image: "https://images.unsplash.com/photo-1615966192539-f1731963b19a?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Discovering Sikkim | A Journey To Haven",
  ...
  {
    id: 4,
    image: "https://images.unsplash.com/photo-1515747802812-e9226ae7e01b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: "Discovering Sikkim | A Journey To Haven",
  ...
  },
  {
    ...
    title: "Sikkim Winter Wonderland Tour",
...
const PopularForDomestic = () => {
    return (
      <div className="container mx-auto px-4 md:px-0 mb-7 pb-20">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">Sikkim</h2>
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  ...
                  <div>
                    <div className="bg-gray-100 p-3 mt-3 rounded-lg">
                      <span className="bg-black text-white text-sm px-2 py-1 rounded">{pkg.days} Sikkim</span>
                      <div className="mt-2">
  ...
  export default PopularForDomestic;