...
const InternnationalDestination = () => {
  return (
    <section className="bg-white md:bg-gradient-to-b from-[#F1FFB600] to-[#F1FFB6] py-10 mb-10">
...
export default InternnationalDestination;
